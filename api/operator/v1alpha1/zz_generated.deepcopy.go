...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CSPExtensionConfig) DeepCopyInto(out *CSPExtensionConfig) {
	*out = *in
	if in.FrameAncestors != nil {
		in, out := &in.FrameAncestors, &out.FrameAncestors
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
	if in.ConnectSrc != nil {
		in, out := &in.ConnectSrc, &out.ConnectSrc
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CSPExtensionConfig.
func (in *CSPExtensionConfig) DeepCopy() *CSPExtensionConfig {
	if in == nil {
		return nil
	}
	out := new(CSPExtensionConfig)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ConfigSpec) DeepCopyInto(out *ConfigSpec) {
	*out = *in
	if in.AuditUrl != nil {
		in, out := &in.AuditUrl, &out.AuditUrl
		*out = new(string)
		**out = **in
	}
	if in.AuditSecret != nil {
	...
	if in.CSPExtension != nil {
		in, out := &in.CSPExtension, &out.CSPExtension
		*out = new(CSPExtensionConfig)
		(*in).DeepCopyInto(*out)
	}
	...
	if in.AccountIamURL != nil {
		in, out := &in.AccountIamURL, &out.AccountIamURL
		*out = new(string)
		**out = **in
	}
	...
	if in.LDAPAllowlistEnabled != nil {
		in, out := &in.LDAPAllowlistEnabled, &out.LDAPAllowlistEnabled
		*out = new(bool)
		**out = **in
	}
}
