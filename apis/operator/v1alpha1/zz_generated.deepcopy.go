...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PgsqlServiceSpec) DeepCopyInto(out *PgsqlServiceSpec) {
	*out = *in
	if in.Resources != nil {
		in, out := &in.Resources, &out.Resources
		*out = new(v1.ResourceRequirements)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PgsqlServiceSpec.
func (in *PgsqlServiceSpec) DeepCopy() *PgsqlServiceSpec {
	if in == nil {
		return nil
	}
	out := new(PgsqlServiceSpec)
	in.DeepCopyInto(out)
	return out
}
