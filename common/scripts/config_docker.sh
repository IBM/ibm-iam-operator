...
DOCKER_REGISTRIES=(
  "${DOCKER_REGISTRY}/hyc-cloud-private-integration-docker-local"
  "${DOCKER_REGISTRY}/hyc-cloud-private-edge-docker-local"
)
...
do
  ${CONTAINER_CLI} login "${registry}" -u "${DOCKER_USERNAME}" -p "${DOCKER_PASSWORD}"
done
