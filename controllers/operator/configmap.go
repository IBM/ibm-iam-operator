...
func createOrGetClusterClient() (client.Client, error) {
	...
	OpenShiftConfigScheme.AddKnownTypes(ConfigSchemeGroupVersion, &osconfigv1.Ingress{}, &osconfigv1.IngressList{})
	OpenShiftConfigScheme.AddKnownTypes(ConfigMapSchemeGroupVersion, &corev1.ConfigMap{}, &corev1.ConfigMapList{})
