...
func (r *AuthenticationReconciler) createUpdateFromYaml(instance *operatorv1alpha1.Authentication, scheme *runtime.Scheme, yamlContent []byte) error {
...
func (r *AuthenticationReconciler) newPgsqlServiceSpec(instance *operatorv1alpha1.Authentication) *operatorv1alpha1.PgsqlServiceSpec {
	...
	return &operatorv1alpha1.PgsqlServiceSpec{LogLevel: instance.Spec.PgsqlService.LogLevel, StorageClass: instance.Spec.PgsqlService.StorageClass, ImageName: ctrlCommon.GetImageRef("POSTGRESQL_IMAGE"), CpuReq: cpuReq, MemReq: memReq, ESReq: esReq, CpuLim: cpuLim, MemLim: memLim, ESLim: esLim}
}

func (r *AuthenticationReconciler) getStorageClass() (string, error) {
...
func (r *AuthenticationReconciler) storageClassAvailable(storageClass string) bool {
	var scExist bool
	scList := &storagev1.StorageClassList{}
	err := r.List(context.TODO(), scList)
	if err != nil {
