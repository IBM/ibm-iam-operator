...
func (r *AuthenticationReconciler) handlePgsqlCerts(instance *operatorv1alpha1.Authentication, currentCertificate *certmgrv1.Certificate, needToRequeue *bool) error {
	...
	err := r.Get(context.TODO(), types.NamespacedName{Name: serverCrt, Namespace: namespace}, currentCertificate)
	if err != nil && k8serrors.IsNotFound(err) {
		...
		err = r.Create(context.TODO(), newCertificate)
		if err != nil {
	...
	err = r.Get(context.TODO(), types.NamespacedName{Name: clientCrt, Namespace: namespace}, currentCertificate)
	if err != nil && k8serrors.IsNotFound(err) {
...
func (r *AuthenticationReconciler) certificateForEDBCluster(instance *operatorv1alpha1.Authentication, cert string) *certmgrv1.Certificate {
...
func (r *AuthenticationReconciler) certificateForEDBClient(instance *operatorv1alpha1.Authentication, cert string) *certmgrv1.Certificate {
