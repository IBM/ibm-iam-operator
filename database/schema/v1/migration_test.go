...
var _ = Describe("MigrationQueue", func() {
	DescribeTable("UpdatePrioritiesByDependencyCount",
		...
		Entry("InitOperandSchemas, IncreaseOIDCUsernameSize, CreateMetadataSchema, and MongoToV1",
			func() []*migration.Migration {
				return []*migration.Migration{
					IncreaseOIDCUsernameSize,
					MongoToV1,
			...
			}, []string{CreateMetadataSchema.Name, InitOperandSchemas.Name, IncreaseOIDCUsernameSize.Name, MongoToV1.Name}),
	)
})
