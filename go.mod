...
replace (
	...
	golang.org/x/crypto => golang.org/x/crypto v0.17.0 //v0.0.0-20201216223049-8b5274cf687f
...
replace github.com/emicklei/go-restful/v3 => github.com/emicklei/go-restful/v3 v3.11.0
