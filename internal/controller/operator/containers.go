...
func buildAuthServiceContainer(instance *operatorv1alpha1.Authentication, authServiceImage string, ldapSpcExist bool) corev1.Container {
	...
	idpEnvVarList := []string{"NODE_ENV", "MASTER_PATH", "MASTER_HOST", "IDENTITY_PROVIDER_URL", "HTTP_ONLY", "SESSION_TIMEOUT", "LDAP_RECURSIVE_SEARCH", "LDAP_ATTR_CACHE_SIZE", "LDAP_ATTR_CACHE_TIMEOUT", "LDAP_ATTR_CACHE_ENABLED", "LDAP_ATTR_CACHE_SIZELIMIT",
		...
		"DB_CONNECT_TIMEOUT", "DB_IDLE_TIMEOUT", "DB_CONNECT_MAX_RETRIES", "DB_POOL_MIN_SIZE", "DB_POOL_MAX_SIZE", "DB_SSL_MODE", "IAM_UM", "OAUTH_21_ENABLED", "LIBERTY_SAMESITE_COOKIE", "ACCOUNT_IAM_URL", "LIBERTY_AUTH_CACHE_TIMEOUT", "LDAP_CLIENT_CONNECT_TIMEOUT"}
...
func buildIdentityManagerContainer(instance *operatorv1alpha1.Authentication, identityManagerImage string, ldapSpcExist bool) corev1.Container {
	...
	idpEnvVarList := []string{"NODE_ENV", "LOG_LEVEL_IDMGMT", "LOG_LEVEL_MW", "IBM_CLOUD_SAAS", "MASTER_HOST", "IBMID_PROFILE_URL", "IBMID_PROFILE_CLIENT_ID", "IBMID_PROFILE_FIELDS", "AUDIT_DETAIL",
		...
		"ACCOUNT_IAM_URL", "EXPOSE_ADDITIONAL_PATHS"}
