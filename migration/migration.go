...
func insertSSUserRelatedRows(ctx context.Context, mongodb *MongoDB, postgres *PostgresDB) (err error) {
	...
	for cursor.Next(ctx) {
		...
		ssUserCustomMap := filterToSSUserCustomMap(ssUserMap)
...
func insertSSGroupRelatedRows(ctx context.Context, mongodb *MongoDB, postgres *PostgresDB) (err error) {
	...
	for cursor.Next(ctx) {
		...
		ssGroupCustomMap := filterToSSGroupCustomMap(ssGroupMap)
...
func filterToSSUserCustomMap(ssUserMap map[string]any) map[string]any {
...
func filterToSSGroupCustomMap(ssGroupMap map[string]any) map[string]any {
