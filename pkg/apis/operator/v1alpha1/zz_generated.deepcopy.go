...
func (in *SecurityOnboardingSpec) DeepCopyInto(out *SecurityOnboardingSpec) {
	*out = *in
	out.IAMOnboarding = in.IAMOnboarding
	out.InitAuthService = in.InitAuthService
	out.InitIdentityProvider = in.InitIdentityProvider
	out.InitIdentityManager = in.InitIdentityManager
	out.InitTokenService = in.InitTokenService
	out.InitPAP = in.InitPAP
	out.Config = in.Config
	return
}
