...
func buildIdentityProviderContainer(instance *operatorv1alpha1.Authentication, identityProviderImage string, icpConsoleURL string) corev1.Container {
	...
	idpEnvVarList := []string{"NODE_ENV", "LOG_LEVEL_IDPROVIDER", "LOG_LEVEL_MW", "PROVIDER_ISSUER_URL", "IDTOKEN_LIFETIME", "ROKS_ENABLED", "ROKS_URL", "OS_TOKEN_LENGTH", "LIBERTY_TOKEN_LENGTH",
