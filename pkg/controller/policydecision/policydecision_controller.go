...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	err = c.Watch(source.Kind(mgr.GetCache(), &operatorv1alpha1.PolicyDecision{}), &handler.EnqueueRequestForObject{})
	if err != nil {
		return err
	}
	...
	err = c.Watch(
		source.Kind(mgr.GetCache(), &certmgr.Certificate{}),
		handler.EnqueueRequestForOwner(mgr.GetScheme(), mgr.GetRESTMapper(), &operatorv1alpha1.PolicyDecision{}, handler.OnlyControllerOwner()),
	)
	if err != nil {
		return err
	}
	...
	err = c.Watch(
		source.Kind(mgr.GetCache(), &net.Ingress{}),
		handler.EnqueueRequestForOwner(mgr.GetScheme(), mgr.GetRESTMapper(), &operatorv1alpha1.PolicyDecision{}, handler.OnlyControllerOwner()),
	)
	if err != nil {
		return err
